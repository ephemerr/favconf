...
focus_bydirection = function(dir) 
return  function ()
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Down",    focus_bydirection("down")  ),
    ...
    awful.key({ modkey,           }, "F3", function () awful.util.spawn("fkey 3") end),
    awful.key({ modkey,           }, "F4", function () awful.util.spawn("fkey 4") end),
    ...
    awful.key({ "Shift",           }, "F10", function () awful.util.spawn("fkey S10") end),
    awful.key({ "Shift",           }, "F11", function () awful.util.spawn("fkey S11") end),
    awful.key({ "Shift",           }, "F12", function () awful.util.spawn("fkey S12") end),
    -- other spawn keys
